...
const AttendanceRecordsScreen = () => {
  ...
  return (
    <div className="mt-6 px-4 flex flex-col gap-10">
      <Card>
        <CardTitle className="text-center p-3"><h1 className="text-2xl font-bold text-center mb-6 flex flex-col justify-start px-10"><span>Kindergarten Children</span></h1></CardTitle>
      </Card>
